...
urlpatterns = [
    ...
    re_path(r'^(?P<course_pk>\d+)/t(?P<step_pk>\d+)/$', views.text_detail,
            name='text'),
    re_path(r'^(?P<course_pk>\d+)/q(?P<step_pk>\d+)/$', views.quiz_detail,
            name='quiz'),

    re_path(r'^(?P<course_pk>\d+)/create_quiz/$', views.quiz_create,
            name='create_quiz'),
    re_path(r'^(?P<course_pk>\d+)/edit_quiz/(?P<quiz_pk>\d+)/$', views.quiz_edit,
            name='edit_quiz'),
